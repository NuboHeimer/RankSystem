...
- **\[RankSystem] Clear All Users Coins** -- экшен для обнуления коинов у всех пользователей. Использовать с осторожностью! В дальнейшем будет вынесен, как минимум, в отдельную группу. Как максимум -- в интерфейс.
- **\[RankSystem] DROP DATABASE** -- экшен для ⚠***полного удаления***⚠ всей базы. В дальнейшем будет вынесен, как минимум, в отдельную группу. Как максимум -- в интерфейс.
